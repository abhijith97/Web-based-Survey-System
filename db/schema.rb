...
ActiveRecord::Schema.define(version: 20160914183152) do
  ...
  create_table "ques", force: :cascade do |t|
    ...
    t.text     "c"
    t.text     "d"
    t.integer  "SurveySet_id"
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
  end

  add_index "ques", ["SurveySet_id"], name: "index_ques_on_SurveySet_id"
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.string   "c"
    t.string   "d"
    t.integer  "SurverySet_id"
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
  end

  add_index "questions", ["SurverySet_id"], name: "index_questions_on_SurverySet_id"
  ...
  add_index "quests", ["SurveySet_id"], name: "index_quests_on_SurveySet_id"
